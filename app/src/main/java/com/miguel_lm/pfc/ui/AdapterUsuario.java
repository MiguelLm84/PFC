...
public class AdapterUsuario extends RecyclerView.Adapter<AdapterUsuario.UsuarioViewHolder>{
    ...
    @Override
    // onBindViewHolder se ejecuta N veces {n veces = lista.size()}
    public void onBindViewHolder(@NonNull UsuarioViewHolder holder, int position) {
        ...
        if(FotoPerfilProvider.fotoPerfil!=null) {
            holder.foto.setImageBitmap(Bitmap.createScaledBitmap(FotoPerfilProvider.fotoPerfil, 100, 100, false));
        }
    ...
    public static class UsuarioViewHolder extends RecyclerView.ViewHolder {
        ...
        public UsuarioViewHolder(@NonNull View itemView, SeleccionarUsuario seleccionarUsuario) {
            ...
            foto = itemView.findViewById(R.id.foto_user2);
        }
